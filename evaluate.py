...
def evaluate():
    ...
    tag_map = {'laptop': 'quad',
               ...
               'phone': 'as',
               'camera': 'as' }
    human_label_fname = f'{BASE_DIR}/data_WWW2025/acos/{target_name}_{tag_map[target_name]}_test.tsv'
    pred_aos_fname = f'{BASE_DIR}/data_WWW2025/pred_aspect/{target_name}_as_test.txt'
